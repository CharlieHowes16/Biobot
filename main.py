...
def main():
    ...
    # Button settings for the login/ create account page 
    ...
    while running:
        ...
        if game_state == "Login_Page":
            ...
            chatbot_page(screen, typing, chatbot_user_typing_box, chatbot_message_box, game_state, chatbot_user_typing_text, chatbot_message)


        elif game_state == "Flashcards_Page":
            last_click_time = flashcards_page(screen, biology_notes, current_time, last_click_time, current_username, game_state)

        elif game_state == "Performance_Page": 
            performance_page(game_state, screen)
        
        if game_state in ["Chatbot_Page", "Flashcards_Page", "Performance_Page"]:
            chatbot_clicked, flashcards_clicked, performance_clicked, logout_clicked = main_pages_layout(game_state, screen)
            ...
            elif logout_clicked:  # Added logout handling
